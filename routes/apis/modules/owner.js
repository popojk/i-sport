...
router.get('/stores/:store_id/plans', authenticated, authenticatedOwner, ownerController.getStorePlans)
router.post('/stores/:store_id/plans', authenticated, authenticatedOwner, ownerController.postStorePlans)
router.put('/plans/:plan_id', authenticated, authenticatedOwner, ownerController.putStorePlan)
router.delete('/plans/:plan_id', authenticated, authenticatedOwner, ownerController.deleteStorePlan)
router.get('/stores/:store_id/reviews', authenticated, authenticatedOwner, ownerController.getStoreReviews)
